...
slug: /docs/feature-guides/models-overview
sidebar_position: 4
---
...
**Context length** refers to the amount of information an AI model can process and remember within a single conversation or request.

Models with larger context lengths can handle longer inputs, maintain more conversational history, and perform deeper multi-step reasoning.
...
- **32K–128K tokens**
  Suitable for chat conversations, short documents, and basic analysis

- **200K–400K tokens**
  Ideal for long PDFs, multi-file analysis, and detailed reports

- **1M+ tokens**
  Designed for books, research papers, large codebases, and agent-style memory
