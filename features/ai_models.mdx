...
## How InstaAiTools Uses Models

InstaAiTools automatically selects a default model based on your plan and the task type. You can override and pick a specific model when:
